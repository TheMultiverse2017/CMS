                                    ...
                                    @if (!empty($allMenus))
                                        @forelse ($allMenus as $menu)
                                            <option value="{{ $menu->id ?? null }}"
                                                @if ($menu->id == $post->menu) selected @endif>
                                                {{ $menu->menu ?? null }}
                                            </option>
                        ...
                        <div class="row py-2">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" multiple name="title"
                                        type="text" id="title">
                                </div>
                            </div>
                        </div>
                        <div class="row py-2">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" multiple name="metaDesc" id="metaDesc" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row py-2">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control"  multiple name="mentTags"id="mentTags" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        </div>
                            ...
                            <div class="row py-2">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="content" id="content" cols="100" rows="20"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="py-3">
